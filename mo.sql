...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2024 at 09:46 PM
...
ALTER TABLE `moviegenre`
  ...
  ADD KEY `genreid` (`genreid`,`userid`),
...
ALTER TABLE `movieproductioncompanies`
  ADD KEY `movieid` (`movieid`,`companyid`,`userid`,`deletedby`),
...
ALTER TABLE `movieresolution`
  ADD KEY `movieid` (`movieid`,`resolutionid`,`addedby`,`deletedby`),
  ADD KEY `addedby` (`addedby`),
  ADD KEY `deletedby` (`deletedby`),
...
--
ALTER TABLE `moviegenre`
  ADD CONSTRAINT `moviegenre_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`),
  ADD CONSTRAINT `moviegenre_ibfk_2` FOREIGN KEY (`movieid`) REFERENCES `movies` (`movieid`),
  ADD CONSTRAINT `moviegenre_ibfk_3` FOREIGN KEY (`genreid`) REFERENCES `genres` (`genreid`);
...
ALTER TABLE `movieproductioncompanies`
  ...
  ADD CONSTRAINT `movieproductioncompanies_ibfk_4` FOREIGN KEY (`deletedby`) REFERENCES `users` (`userid`);
...
--
ALTER TABLE `movieresolution`
  ADD CONSTRAINT `movieresolution_ibfk_1` FOREIGN KEY (`addedby`) REFERENCES `users` (`userid`),
  ADD CONSTRAINT `movieresolution_ibfk_2` FOREIGN KEY (`deletedby`) REFERENCES `users` (`userid`),
  ADD CONSTRAINT `movieresolution_ibfk_3` FOREIGN KEY (`movieid`) REFERENCES `movies` (`movieid`),
  ADD CONSTRAINT `movieresolution_ibfk_4` FOREIGN KEY (`resolutionid`) REFERENCES `resolution` (`resolutionid`);
...
--
ALTER TABLE `productioncompanies`
  ADD CONSTRAINT `productioncompanies_ibfk_1` FOREIGN KEY (`addedby`) REFERENCES `users` (`userid`),
  ADD CONSTRAINT `productioncompanies_ibfk_2` FOREIGN KEY (`deletedby`) REFERENCES `users` (`userid`);
